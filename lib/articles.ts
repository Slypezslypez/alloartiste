export type Article = {
  ...
  gradient: string;
  readTime: string;
  date: string; // format affichable, ex. "12 mai 2026"
  body: string[];
};
...
export const ARTICLES: Article[] = [
  {
    ...
    excerpt:
      "Vos photos, votre bio, vos vidéos : chaque détail compte pour convaincre un organisateur en quelques secondes.",
    category: "Conseils carrière",
    icon: "🎨",
    gradient: "linear-gradient(135deg, #d4af37, #8b6b1f)",
    readTime: "4 min",
    date: "8 juin 2026",
    body: [
      "Un organisateur passe en moyenne moins de 30 secondes sur un profil avant de décider s'il vous contacte ou passe au suivant. Voici ce qui fait vraiment la différence sur cette courte fenêtre d'attention.",
      ...
      "5. Complétez votre ville et vos disciplines précisément : c'est ce qui vous fait apparaître dans les bonnes recherches, au bon moment."
    ]
  },
  {
    slug: "bien-briefer-un-artiste",
    title: "Organisateurs : comment bien briefer un artiste avant l'événement",
    excerpt: "Lieu, horaires, matériel technique, public attendu... un bon brief évite la plupart des malentendus le jour J.",
    ...
    date: "24 mai 2026",
    body: [
      "La majorité des incidents le jour d'un événement viennent d'un détail non communiqué à l'avance, pas d'un manque de professionnalisme. Voici les informations à transmettre systématiquement.",
      ...
      "Enfin, un contact sur place joignable le jour même évite bien des stress si un détail doit être ajusté en dernière minute."
    ]
  },
  {
    slug: "tarifer-sa-prestation",
    title: "Comment fixer le prix de sa prestation artistique",
    excerpt: "Entre le temps de préparation, le déplacement et le matériel, voici une méthode simple pour arriver à un tarif juste.",
    category: "Conseils carrière",
    icon: "💰",
    ...
    date: "12 mai 2026",
    body: [
      "Fixer son tarif est souvent l'exercice le plus inconfortable pour un artiste indépendant. Une méthode simple : décomposer le prix en quatre blocs plutôt que de sortir un chiffre au feeling.",
      ...
      "Une fois ces quatre blocs additionnés, comparez avec ce que pratiquent d'autres artistes de votre discipline dans votre région pour ajuster si besoin. N'hésitez pas non plus à prévoir un tarif différent pour un particulier et pour une entreprise ou une collectivité — le budget disponible n'est généralement pas le même."
    ]
  },
  {
    ...
    date: "2 mai 2026",
    body: [
      "Un événement réussi se prépare autant en amont que le jour même. Voici la liste minimale à cocher, que vous soyez organisateur ou artiste.",
      ...
      "Après l'événement : un petit mot de remerciement ou un retour rapide fait souvent la différence pour une future collaboration."
    ]
  }
];
